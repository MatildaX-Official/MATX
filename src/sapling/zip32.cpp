...
const unsigned char MATX_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'P', 'I', 'V', 'X', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char MATX_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
...
{
    CBLAKE2bWriter h(SER_GETHASH, 0, MATX_HD_SEED_FP_PERSONAL);
    h << seed;
    return h.GetHash();
}
