...
// Copyright (c) 2015-2019 The MATX Core developers
...
/** MATX unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    //! Short name
    static QString name(int unit, bool isZmat = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZMAT = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZMAT = false);
