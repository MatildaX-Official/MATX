...
/** Utility functions used by the MATX Qt UI.
 */
namespace GUIUtil
{
...
// Render MATX addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmat = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZmat = false);
...
// Parse "matx:" URI into recipient object, return true on successful parsing
