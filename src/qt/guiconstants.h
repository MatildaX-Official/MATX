...
// Copyright (c) 2015-2020 The MATX Core developers
...
/* Matx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MATX"
#define QAPP_ORG_DOMAIN "matx.org"
#define QAPP_APP_NAME_DEFAULT "MATX-Qt"
#define QAPP_APP_NAME_TESTNET "MATX-Qt-testnet"
