...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeMatxAmount") || reset)
        gArgs.SoftSetArg("-anonymizematxamount", settings.value("nAnonymizeMatxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in matx.cpp during shutdown to also remove the window positions
