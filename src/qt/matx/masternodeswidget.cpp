...
#include "qt/matx/forms/ui_masternodeswidget.h"

#include "qt/matx/qtutils.h"
#include "qt/matx/mnrow.h"
#include "qt/matx/mninfodialog.h"
#include "qt/matx/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(MATXGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::MAT)));
        return;
    }
