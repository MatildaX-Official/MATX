...
#include "qt/matx/createproposaldialog.h"
#include "qt/matx/forms/ui_createproposaldialog.h"

#include "qt/matx/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(MATXGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.matx/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 MAT");
