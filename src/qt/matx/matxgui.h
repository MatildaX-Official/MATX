...
#ifndef MATX_CORE_NEW_GUI_MATXGUI_H
#define MATX_CORE_NEW_GUI_MATXGUI_H
...
#include "qt/matx/navmenuwidget.h"
#include "qt/matx/topbar.h"
#include "qt/matx/dashboardwidget.h"
#include "qt/matx/send.h"
#include "qt/matx/receivewidget.h"
#include "qt/matx/addresseswidget.h"
#include "qt/matx/coldstakingwidget.h"
#include "qt/matx/governancewidget.h"
#include "qt/matx/masternodeswidget.h"
#include "qt/matx/snackbar.h"
#include "qt/matx/settings/settingswidget.h"
...
/**
  MATX GUI main class. This class represents the main window of the MATX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MATXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MATXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MATXGUI();
...
#endif //MATX_CORE_NEW_GUI_MATXGUI_H
