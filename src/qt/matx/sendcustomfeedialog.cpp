...
#include "qt/matx/sendcustomfeedialog.h"
#include "qt/matx/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MATXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MATXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
