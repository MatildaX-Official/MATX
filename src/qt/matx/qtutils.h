...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MATXGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, MATXGUI* gui, double posX = 3);
