// Copyright (c) 2019-2020 The MATX Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/matx/settings/settingswalletrepairwidget.h"
#include "qt/matx/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/matx/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MATXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MATXGUI::handleRestart()
