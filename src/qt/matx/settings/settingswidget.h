...
#include "qt/matx/settings/settingsbackupwallet.h"
#include "qt/matx/settings/settingsexportcsv.h"
#include "qt/matx/settings/settingsbittoolwidget.h"
#include "qt/matx/settings/settingssignmessagewidgets.h"
#include "qt/matx/settings/settingswalletrepairwidget.h"
#include "qt/matx/settings/settingswalletoptionswidget.h"
#include "qt/matx/settings/settingsmainoptionswidget.h"
#include "qt/matx/settings/settingsdisplayoptionswidget.h"
#include "qt/matx/settings/settingsinformationwidget.h"
#include "qt/matx/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(MATXGUI* parent);
    ~SettingsWidget();
