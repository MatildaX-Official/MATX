...
QString BitcoinUnits::id(int unit)
{
    ...
    case MAT:
        return QString("matx");
    case mMAT:
        return QString("mmatx");
    case uMAT:
        return QString::fromUtf8("umatx");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZmat)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMAT)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZMAT);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMAT)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZMAT));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
