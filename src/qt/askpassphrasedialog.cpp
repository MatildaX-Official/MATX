...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MATXGUI* window = static_cast<MATXGUI*>(parentWidget());
...
{
    MATXGUI* gui = static_cast<MATXGUI*>(parentWidget());
...
{
    hide();
    static_cast<MATXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MATs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
