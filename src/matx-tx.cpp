...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " matx-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  matx-tx [options] <hex-tx> [commands]  Update hex-encoded matx transaction\n" +
                               "or:     matx-tx [options] -create [commands]   Create hex-encoded matx transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded matx transaction
