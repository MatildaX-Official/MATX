...
#error Client version information missing: version is not defined by matx-config.h or in any other way
#endif
...
/**
 * matxd-res.rc includes this file, but it cannot cope with real c++ code.
