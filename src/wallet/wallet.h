...
#ifndef MATX_WALLET_H
#define MATX_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_MATX = 61000, // inherited version..
...
public:
     ...
     * MATX: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 MAT output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CMatStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
