...
RESOURCES += src/qt/matx.qrc src/qt/matx_locale.qrc

TRANSLATIONS += src/qt/locale/matx_bg.ts \
                src/qt/locale/matx_de.ts \
                src/qt/locale/matx_en.ts \
                src/qt/locale/matx_es.ts \
                src/qt/locale/matx_fi.ts \
                src/qt/locale/matx_fr.ts \
                src/qt/locale/matx_it.ts \
                src/qt/locale/matx_ja.ts \
                src/qt/locale/matx_pl.ts \
                src/qt/locale/matx_pt.ts \
                src/qt/locale/matx_ru.ts \
                src/qt/locale/matx_sk.ts \
                src/qt/locale/matx_sv.ts \
                src/qt/locale/matx_vi.ts \
                src/qt/locale/matx_zh_CN.ts \
                src/qt/locale/matx_zh_TW.ts
