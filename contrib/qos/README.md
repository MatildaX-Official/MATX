...
This means one can have an always-on matxd instance running, and another local matxd/matx-qt instance which connects to this node and receives blocks from it.
