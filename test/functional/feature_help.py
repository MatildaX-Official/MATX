...
"""Verify that starting matx with -h works as expected."""
...
class HelpTest(MatxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start matx with -? for help text")
        ...
        self.log.info("Start matx with -version for version information")
