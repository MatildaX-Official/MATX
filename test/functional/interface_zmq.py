...
from test_framework.test_framework import MatxTestFramework, SkipTest
...
class ZMQTest (MatxTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that matx has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("matxd has not been built with zmq enabled.")
