...
class DIP3Test(MatxTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 MAT) to the operator, and (2 * 2.7 MAT) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid MATX address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid MATX address InvalidPayee", controller.protx_update_registrar,
