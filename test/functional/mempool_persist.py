...
By default, matxd will dump mempool on shutdown and
...
class MempoolPersistTest(MatxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent matxd from writing mempool.dat to disk. Verify that `savemempool` fails")
