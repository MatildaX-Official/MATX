...
# Copyright (c) 2020-2022 The MATX Core developers
...
class FullBlockTest(MatxTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure matxd isn't accepting b26
        ...
        # Extend the b28 chain to make sure matxd isn't accepting b28
        ...
        # MATX: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the matx code has custom code which does so);
