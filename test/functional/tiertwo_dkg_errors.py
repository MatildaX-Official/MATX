...
from test_framework.test_framework import MatxDMNTestFramework, ExpectedDKGMessages
...
class DkgErrorsTest(MatxDMNTestFramework):

    def set_test_params(self):
        self.set_base_test_params()
        self.extra_args = [["-nuparams=v5_shield:1", "-nuparams=MATX_v5.5:130", "-nuparams=v6_evo:130", "-debug=llmq", "-debug=dkg", "-debug=net"]] * self.num_nodes
