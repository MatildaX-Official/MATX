...
COIN = 100000000  # 1 MAT in satoshis
...
# Objects that map to matxd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in matxd indicates these should be deserialized as blocks
