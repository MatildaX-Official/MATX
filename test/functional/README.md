...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the MatxTestFramwork, place overrides for the
...
with the matxd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a matxd.  `P2PInterface`
...
Basic code to support P2P connectivity to a matxd.
