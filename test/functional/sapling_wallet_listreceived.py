...
class ListReceivedTest (MatxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 MAT.
        ...
        # Send 1 MAT to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 MAT sending them all (fee is 0.1 MAT)
        ...
        # Confirm transaction (2 MAT from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 MAT, send 0.6 MAT + 0.05 MAT fee
