...
To build MATX Core using AFL instrumentation (this assumes that the
...
with certain assembly code from MATX Core's code. See [developer notes on sanitizers](https://github.com/MatildaX-Official/MATX/blob/master/doc/developer-notes.md#sanitizers)
