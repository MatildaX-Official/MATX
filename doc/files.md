...
matx.conf           | contains configuration settings for matxd or matx-qt
matxd.pid           | stores the process id of matxd while running
...
debug.log           | contains debug information and general logging generated by matxd or matx-qt
