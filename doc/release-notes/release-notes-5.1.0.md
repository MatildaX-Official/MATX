MATX Core version v5.1.0 is now available from:  <https://github.com/matx-project/matx/releases>
...
- #2170 Better matx.conf Masternode data error notification (furszy)
