Contributing to MATX Core
============================

The MATX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/matx-project/matx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MATX Core project, and is not to be
confused with overall MATX Network Protocol consensus changes.

Whether a pull request is merged into MATX Core rests with the project merge
...
Patches that change MATX consensus rules are considerably more involved than
...
Where a patchset proposes to change the MATX consensus, it must have been
...
The project leader is the release manager for each MATX Core release.
